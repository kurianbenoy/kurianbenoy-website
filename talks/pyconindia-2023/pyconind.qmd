...
- <span style="color:red">I think Whisper^[<span style="color:black">According to [research paper](https://cdn.openai.com/papers/whisper.pdf) p.2, the name Whisper is an abbrevation for WSPSR: `Web-scale Supervised Pretraining for Speech Recognition`.</span>] is the most `under-rated model` released by OpenAI.</span>
...
::: aside
- <span style="color:black">More details can be found in Section 3.4 of [Whisper research  paper](https://cdn.openai.com/papers/whisper.pdf) pp.6 - 8. </span>
- <span style="color:black">Zero-shot Whisper improves performance on Multilingual LibriSpeech(MLS) but is still significantly behind both Maestro, XLS-R, and mSLAM on VoxPopuli. ([Whisper research  paper](https://cdn.openai.com/papers/whisper.pdf) p.7) </span>
:::
...
- JAX implementation of OpenAI Whisper model upto 70x speedup on TPU using [Whisper JAX](https://github.com/sanchit-gandhi/whisper-jax)
- 4x faster with same accuracy using [faster-whisper](https://github.com/guillaumekln/faster-whisper)
- [Useful transformer](https://github.com/usefulsensors/useful-transformers/tree/main/examples/whisper) makes 2x faster than faster-whisper.
...
::: aside
<span style="color:black">For more checkout [awesome list by Sindre Sorhus](https://github.com/sindresorhus/awesome-whisper)</span>
...
::: aside
- <span style="color:black">Based on article [Fine-Tune Whisper For Multilingual ASR with 🤗 Transformers](https://huggingface.co/blog/fine-tune-whisper)</span>
...
![Remembering my first Python teacher](JumanaMiss.jpg){width=700 fig-align=left}
