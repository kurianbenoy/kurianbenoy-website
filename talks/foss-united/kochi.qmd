---
title: Whisper and it's amazing power to do fine-tuning demonstrated on my mother-tongue
author: Kurian Benoy
subtitle: 📍 FOSS Meetup, Kochi @ KeyValue Software Systems, Smart Kochi.
date: 2023-06-24
date-format: full
comments: false
format:
  revealjs:
    theme: solarized
    slide-number: true
    footer: "[Kurian Benoy](https://kurianbenoy.com/) || Whisper and it's amazing power to fine-tune models demonstrated in my mother tongue"
---

## Outline

- What is OpenAI Whisper? (3 minutes)
- What are features of OpenAI Whisper? (3 minutes)
<!-- - History of models before and after OpenAI Whisper (5 minutes) -->
- What is Fine-tuning and how to fine-tune Whisper? (3 minutes)
- About my mother tongue (2 minute)
- Methadology of benchmarking OpenAI whisper models? (7 minutes)
...
::: aside
Appendix D2.2.2  CommonVoice9 dataset results, ([Whisper research paper](https://cdn.openai.com/papers/whisper.pdf) p.23).
:::
...
- Development library: nbdev
- Dependencies:

`transformers>=4.0.0,<5 datasets jiwer numerize pandas librosa soundfile==0.12.1 whisper_normalizer`
