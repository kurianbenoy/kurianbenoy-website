...
- Methadology of benchmarking whisper models
...
## Running the benchmarking of a particular model weight
...
```{.python code-line-numbers="11-13|14|21-24"}
...
## Calculating wer, cer, total wer, total cer
...
## Calculating model_size, storing it as dataset
