...
<!-- Introduction, why created project, methadology of benchmarking and results of benchmarking -->
...
- <span style="color:blue">Validate whether finetuned-whisper models where working in Malayalam.</span>
...
1. Create a python library for benchmarking models.
2. Calculate WER using produced the output of hypothesis and compare it with groundtruth
3. Build a reproducible methadology

<!-- academia loves formula/ well defined steps -->
<!-- talk about idea of reproducible research -->
