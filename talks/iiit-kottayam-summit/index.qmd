---
title: OpenAI Whisper’s amazing power to do fine-tuning demonstrated with benchmarking on Malayalam
...
format:
  revealjs:
    theme: solarized
    slide-number: true
    footer: "[Kurian Benoy](https://kurianbenoy.com/) || OpenAI Whisper's amazing power to do fine-tuning demonstrated with benchmarking on Malayalam"
---
...
Whisper sadly doesn't support Malayalam!
