...
- <span style="color:blue">The best model now is: `thennal/whisper-medium-ml`
- <span style="color:green">I think their seems to be good ASR models suitable for production use-cases.</span>
